    ...
    public static function insertar_usuario($conexion, $usuario){
        ...
        if(isset($conexion)){
            try {
                ...
                $nombrebp = $usuario -> obtener_nombre();
                $emailbp = $usuario -> obtener_email();
                $passwordbp = $usuario -> obtener_password();
                
                $sentencia -> bindParam(':nombre', $nombrebp, PDO::PARAM_STR);
                $sentencia -> bindParam(':email', $emailbp, PDO::PARAM_STR);
                $sentencia -> bindParam(':password', $passwordbp, PDO::PARAM_STR);
